package top.kwseeker.springboot.lab03.springsecurity.user.covert;
...
public interface AuthConvert {
    ...
    //    menuList.forEach(menu -> treeNodeMap.put(menu.getId(), cn.iocoder.yudao.module.system.convert.auth.AuthConvert.INSTANCE.convertTreeNode(menu)));
    //    // 处理父子关系
