package top.kwseeker.cloud.common.exception.util;

import lombok.extern.slf4j.Slf4j;
import top.kwseeker.cloud.common.exception.ErrorCode;
import top.kwseeker.cloud.common.exception.ServiceException;
...
public class ServiceExceptionUtil {
    ...
    public static ServiceException invalidParamException(String messagePattern, Object... params) {
        return exception0(ErrorCode.BAD_REQUEST.getCode(), messagePattern, params);
    }
